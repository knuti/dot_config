...
plugins=(git vi-mode ssh-agent tmuxinator gpg-agent)
...
alias ls="eza --icons=always -a --git-ignore"
...
# zsh syntax highlighting and colorscheme setting
source ~/projects/dracula/zsh-syntax-highlighting/zsh-syntax-highlighting.sh
